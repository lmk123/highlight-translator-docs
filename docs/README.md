...
- title: 功能丰富
  details: 支持 9 个国内外主流翻译源如谷歌、DeepL、百度、搜狗等，且均可用于网页翻译。能对比、朗读、复制翻译结果。能在 PDF 里使用。支持辅助键、快捷键、悬浮取词。
- title: 持续更新
...
![Edge 扩展商店版本](https://img.shields.io/static/v1?label=版本&message=v7.5.9&color=informational&style=flat-square)
